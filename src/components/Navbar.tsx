...
export default function Navbar() {
    ...
    return (
        <div className={`fixed font-open-sans z-10 top-0 flex h-20 pt-2 md:pt-4 w-full px-4 md:px-14 lg:px-32 bg-transparent justify-between items-center ${hasScrolled ? 'backdrop-blur-3xl' : ''}`}>
            {/* Logo */}
