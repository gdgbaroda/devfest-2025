export default function Description() {
  return (
    <div className="flex flex-col w-full justify-top items-center gap-8 md:gap-16 px-4 md:px-8 lg:px-16 md:py-16">
      {/* Tagline */}
      <div className=" italic text-2xl md:text-4xl text-center font-extrabold">
      ...
      {/* Description */}
      <div className="max-w-4xl text-center px-4 md:px-8 lg:px-16 text-lg md:text-xl  text-gray-700">
